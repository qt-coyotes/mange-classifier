4090:
	python3 main.py --batch_size 32 --learning_rate 0.0001 --num_sanity_val_steps 1 --patience 5 --model ResNet34 --criterion awBCELoss --monitor val_loss --message "no dens + crop + data augmentation 1 fixed LR 0.0001"
	python3 main.py --batch_size 32 --learning_rate 0.001 --num_sanity_val_steps 1 --patience 5 --model ResNet34 --criterion awBCELoss --monitor val_loss --message "no dens + crop + data augmentation 1 fixed LR 0.001"
	python3 main.py --batch_size 32 --learning_rate 0.00001 --num_sanity_val_steps 1 --patience 5 --model ResNet34 --criterion awBCELoss --monitor val_loss --message "no dens + crop + data augmentation 1 0.00001"
