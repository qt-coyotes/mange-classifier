4090:
	python3 main.py --num_sanity_val_steps 1 --patience 5 --internal_group --model SuperLearner --message "superlearner v1" --metadata_path data/CHIL/CHIL_uwin_mange_Marit_07242020.json
