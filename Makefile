...
#	python3 main.py --batch_size 512 --learning_rate 0.00002 --num_sanity_val_steps 1 --patience 5 --model ResNet
	python3 main.py --batch_size 128 --learning_rate 0.00002 --num_sanity_val_steps 1 --patience 5 --model ViT
# python3 main.py --batch_size 64 --learning_rate 0.0002 --num_sanity_val_steps 1 --patience 5 --model YOLO
