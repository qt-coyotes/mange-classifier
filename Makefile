4090:
	python3 main.py --batch_size 32 --auto_lr_find --num_sanity_val_steps 1 --patience 5 --model ResNet34 --criterion dwBCELoss --no_crop --no_tabular_features --no_data_augmentation --monitor val_EC5 --internal_k 10 --message "Alternative dwBCE InternalK 10"
	python3 main.py --batch_size 32 --auto_lr_find --num_sanity_val_steps 1 --patience 5 --model ResNet34 --criterion dwBCELoss --no_crop --no_tabular_features --no_data_augmentation --monitor val_EC5 --internal_k 10 --internal_group --message "Alternative dwBCE InternalK 10 Internal Group"
	python3 main.py --batch_size 32 --auto_lr_find --num_sanity_val_steps 1 --patience 5 --model ResNet34 --criterion dwBCELoss --no_crop --no_tabular_features --no_data_augmentation --monitor val_EC5 --internal_k 5 --internal_group --message "Alternative dwBCE InternalK 10 Internal Group"
