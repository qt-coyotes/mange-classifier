4090:
	python3 main.py --batch_size 32 --learning_rate 0.00001 --num_sanity_val_steps 1 --patience 5 --model ResNet --criterion ExpectedCost --internal_k 10 --num_workers 12 --scheduler_patience 4
