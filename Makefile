4090:
	-python3 main.py --batch_size 32 --auto_lr_find --learning_rate 0.0001 --num_sanity_val_steps 1 --patience 5 --model ResNet34 --criterion awBCELoss --monitor val_loss --message "dens + crop + data augmentation 1"
