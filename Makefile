4090:
	python3 main.py --batch_size 32 --num_sanity_val_steps 1 --patience 5 --learning_rate 0.0001 --model AllPositive --message "no dens + crop + data augmentation 2 (fix LR)"
